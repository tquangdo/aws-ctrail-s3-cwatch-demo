...
# ~~~~~~~~~~~ 3) CWatch ~~~~~~~~~~~
log_group_name=$(aws logs describe-log-groups --log-group-name-prefix aws-dtq --query 'logGroups[*].logGroupName' --output text) # replace "/aws/lambda" <=> "<LOGGROUP_NAME>"
...
# ~~~~~~~~~~~ 17) cloud trail ~~~~~~~~~~~
aws cloudtrail delete-trail --name DTQCTrailDemo
